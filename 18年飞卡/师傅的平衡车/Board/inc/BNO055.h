...
{                                   //HW SENS POWER    SENS SIG         FUSION
                                    //  A   M   G       A   M   G       E   Q   L   G
    CONFIGMODE      = 0x00,   //  y   y   y       n   n   n       n   n   n   n
    ACCONLY         = 0x01,   //  y   n   n       y   n   n       n   n   n   n
    MAGONLY         = 0x02,   //  n   y   n       n   y   n       n   n   n   n
    GYROONLY        = 0x03,   //  n   n   y       n   n   y       n   n   n   n
    ACCMAG          = 0x04,   //  y   y   n       y   y   n       n   n   n   n
    ACCGYRO         = 0x05,   //  y   n   y       y   n   y       n   n   n   n
    MAGGYRO         = 0x06,   //  n   y   y       n   y   y       n   n   n   n
    AMG             = 0x07,   //  y   y   y       y   y   y       n   n   n   n
    IMU             = 0x08,   //  y   n   y       y   n   y       y   y   y   y
    COMPASS         = 0x09,   //  y   y   n       y   y   n       y   y   y   y
    M4G             = 0x0a,   //  y   y   n       y   y   y       y   y   y   y
    NDOF_FMC_OFF    = 0x0b,   //  y   y   y       y   y   y       y   y   y   y
    NDOF            = 0x0c,   //  y   y   y       y   y   y       y   y   y   y    
...
extern void BNO055UartInit(void);
extern int  BNO055Init(void);
extern void BNO055Write(BNO055Registers_t reg, char value);
extern unsigned char BNO055Read(BNO055Registers_t reg);
extern void BNO055ReadEuler(BNO055EulerData *MyEuler); 
extern void BNO055ReadLinAcc(BNO055LinAccData *MyLinAcc);
extern void BNO055ReadQua(BNO055QuaData *MyQua);
extern void BNO055CalcAbsLinAcc(BNO055QuaData *MyQua, BNO055LinAccData *MyLinAcc, BNO055AbsLinAccData *MyALA);
#endif