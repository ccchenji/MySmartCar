...
extern void    i2c_write_reg(I2Cn_e, uint8 SlaveID, uint8 reg, uint8 Data);      
extern uint8   i2c_read_reg (I2Cn_e, uint8 SlaveID, uint8 reg);                  
...
I2C_Type * I2CN[2] = { ((I2C_Type *)(0x40066000u)), ((I2C_Type *)(0x40067000u)) }; 
...
void i2c_Wait(I2Cn_e i2cn)
{
    ...
    while(( I2CN[i2cn]->S & 0x2u)==0)
    {
        num++;
        if(num>wait_num) 
        {
            I2CN[i2cn]->C1 = 0;
            if(i2cn == i2c0)    ((SIM_Type *)(0x40048000u))->SCGC &= ~(uint32)0x10000u;         
            else                ((SIM_Type *)(0x40048000u))->SCGC &= ~(uint32)0x20000u;           
            IIC_init();
            IIC_stop();
            if(i2cn == i2c0)    ((SIM_Type *)(0x40048000u))->SCGC |= 0x10000u;         
            else                ((SIM_Type *)(0x40048000u))->SCGC |= 0x20000u;          
            I2CN[i2cn]->C1 = 0x80u;
            break;
        }
    }
...
uint32 i2c_init(I2Cn_e i2cn, uint32 baud)
{
    ...
    if(i2cn == i2c0)
    {
        ...
        ((SIM_Type *)(0x40048000u))->SCGC |= 0x10000u;           
        
        if(A3 == I2C0_SCL_PIN)
        {
            ((SIM_Type *)(0x40048000u))->PINSEL &= ~(uint32)0x20u;
        }
        else
        {
            ((SIM_Type *)(0x40048000u))->PINSEL |= 0x20u;
        }
    ...
    else
    {
        ...
        ((SIM_Type *)(0x40048000u))->SCGC |= 0x20000u;           
        
        if(E1 == I2C1_SCL_PIN)
        {
            ((SIM_Type *)(0x40048000u))->PINSEL1 &= ~(uint32)0x400u;
        }
        else
        {
            ((SIM_Type *)(0x40048000u))->PINSEL1 |= 0x400u;
        }
    }
    ...
    scldiv =  bus_clk_khz * 1000 / ( (1<<mult) * baud );    
    ...
    I2CN[i2cn]->F  = (((uint8_t)(((uint8_t)(mult))<<6))&0xC0u) | (((uint8_t)(((uint8_t)(icr))<<0))&0x3Fu);     
...
uint8 i2c_read_reg(I2Cn_e i2cn, uint8 SlaveID, uint8 reg)
{
    ...
    {I2CN[i2cn]->C1 |= (0x10u | 0x20u);};                                    

    {I2CN[i2cn]->D = (SlaveID << 1) | MWSR; i2c_Wait(i2cn);};        

    {I2CN[i2cn]->D = reg; i2c_Wait(i2cn);};                          

    {I2CN[i2cn]->C1 |= 0x4u;};                            

    {I2CN[i2cn]->D = ( SlaveID << 1) | MRSW; i2c_Wait(i2cn);};      

    {I2CN[i2cn]->C1 &= ~0x10u; I2CN[i2cn]->C1 |= 0x8u;};                              
    result = I2CN[i2cn]->D;                             
    i2c_Wait(i2cn);                                     

    {I2CN[i2cn]->C1 &= ~(0x20u | 0x10u);};                                     
...
void i2c_write_reg(I2Cn_e i2cn, uint8 SlaveID, uint8 reg, uint8 Data)
{
    ...
    {I2CN[i2cn]->D = Data; i2c_Wait(i2cn);};                         
