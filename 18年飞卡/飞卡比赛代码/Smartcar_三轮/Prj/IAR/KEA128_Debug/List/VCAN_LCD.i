...
void lcd_cross(Site_t site, uint16 len, uint16 Color)
{
    ...
    if (!((site . x < ST7735S_get_w()) && (site . y < ST7735S_get_h()))) assert_failed("C:\\Users\\ZHY\\Desktop\\31.FLASH_\261\344\301\277\266\301\320\264\241\276\315\306\274\366\241\277\\Board\\src\\VCAN_LCD.c", 87);   
