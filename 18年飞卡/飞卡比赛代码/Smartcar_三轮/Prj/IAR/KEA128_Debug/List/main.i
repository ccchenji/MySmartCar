...
void main(void)
{
    ...
    gpio_init(PTH6, GPO, 0); 
    gpio_init(PTH7, GPO, 0); 
    led_init (LED0);
    key_init(KEY_MAX);
    ...
    ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH0, 10000, 100);
    ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH1, 10000, 100); 

    ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH2, 10000, 100); 
    ftm_pwm_init(((FTM_Type *)(0x4003A000u)), FTM_CH3, 10000, 100);
