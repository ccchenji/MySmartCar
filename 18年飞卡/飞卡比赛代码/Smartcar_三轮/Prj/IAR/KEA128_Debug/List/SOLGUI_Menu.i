...
void _UI_MENU(){{ SOLGUI_Cursor(6, 0, 11); SOLGUI_Widget_OptionText(0, "keynum:%d", KEY_NUM); SOLGUI_Widget_GotoPage(1, &EDIT); SOLGUI_Widget_OptionText(2, "lossline:%d", loss_line); SOLGUI_Widget_OptionText(3, "ADC0:%d", adc_value[0]); SOLGUI_Widget_OptionText(4, "ADC1:%d", adc_value[1]); SOLGUI_Widget_OptionText(5, "ADC2:%d", adc_value[2]); SOLGUI_Widget_OptionText(6, "ADC3:%d", adc_value[3]); SOLGUI_Widget_OptionText(7, "position=%d", position); SOLGUI_Widget_OptionText(8, "dir.err=%d", adc_value[3] - adc_value[0]); SOLGUI_Widget_OptionText(9, "SpeedL=%d", motorEncorderL); SOLGUI_Widget_OptionText(10, "SpeedR=%d", motorEncorderR); }} MENU_PAGE UI_MENU={"SmartCar",0,_UI_MENU};;

void _EDIT(){{ SOLGUI_Cursor(6, 0, 8); SOLGUI_Widget_Spin(0,"baseSpeed",0x03,200,0,&g_base_speed); SOLGUI_Widget_Spin(1,"SetSpeed",0x03,200,0,&g_set_speed); SOLGUI_Widget_Spin(2,"dirKp",0x04,100,0,&dir . Kp); SOLGUI_Widget_Spin(3,"dirKd",0x04,100,0,&dir . Kd); SOLGUI_Widget_Spin(4,"DutyMax",0x03,1000,0,&dutyMax); SOLGUI_Widget_Spin(5,"leftThr",0x03,1000,0,&g_leftThrottle); SOLGUI_Widget_Spin(6,"g_rightthr",0x03,1000,0,&g_rightThrottle); SOLGUI_Widget_GotoPage(7,&UI_MENU); }} MENU_PAGE EDIT={"Edit",&UI_MENU,_EDIT};;

void _DISPLAY(){{ SOLGUI_Widget_GotoPage(0,&UI_MENU); }} MENU_PAGE DISPLAY={"Display",&UI_MENU,_DISPLAY};;
