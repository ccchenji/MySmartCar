...
void lcd_cross(Site_t site, uint16 len, uint16 Color)
{
    ...
    if (!((site . x < ST7735S_get_w()) && (site . y < ST7735S_get_h()))) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Board\\src\\VCAN_LCD.c", 87);   
