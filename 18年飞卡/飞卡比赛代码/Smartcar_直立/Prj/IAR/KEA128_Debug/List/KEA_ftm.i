...
static void ftm_port_mux(FTMn_e ftmn, FTM_CHn_e ch)
{
    ...
    case (uint32_t)((FTM_Type *)(0x4003A000u)):
        ...
        case  FTM_CH2:
            ...
            if(PTG4 == PTC2) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<4))&0x30u);
            else if(PTG4 == PTD0) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<4))&0x30u);
            else if(PTG4 == PTG4) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<4))&0x30u);
            break;
        case  FTM_CH3:
            ((((SIM_Type *)(0x40048000u)))->PINSEL1) &= ~0xC0u;     
            if(PTG5 == PTC3) ((((SIM_Type *)(0x40048000u)))->PINSEL1) |= (((uint32_t)(((uint32_t)(0))<<6))&0xC0u);
            else if(PTG5 == PTD1) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(1))<<6))&0xC0u);
            else if(PTG5 == PTG5) ((SIM_Type *)(0x40048000u))->PINSEL1 |= (((uint32_t)(((uint32_t)(2))<<6))&0xC0u);
            break;
        case  FTM_CH4:
            if(PTB4 == PTB4)
            {
...
void  ftm_pwm_finit(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, float duty)  
{
    ...
    if (!(ps <= 0x07)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 183);                 
...
void ftm_pwm_init(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, uint32 duty)
{
    ...
    if (!(ps <= 0x07)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 263);                 
...
void ftm_pwm_duty(FTMn_e ftmn, FTM_CHn_e ch, uint32 duty)
{
    ...
    case (uint32_t)((FTM_Type *)(0x40038000u)):
        if (!(duty <= 1000u)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 342);     
        break;

    case (uint32_t)((FTM_Type *)(0x40039000u)):
        if (!(duty <= 1000u)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 346);     
        break;
    case (uint32_t)((FTM_Type *)(0x4003A000u)):
        if (!(duty <= 1000u)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 349);     
        break;

    default:
        if (!(0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 353);
        break;
    }
    ...
    default:
        if (!(0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 401);
        break;
    }
...
void ftm_pwm_fduty(FTMn_e ftmn, FTM_CHn_e ch, float duty)
{
    ...
    if (!(duty <= 100.0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 425);     
    ...
    default:
        if (!(0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 456);
        break;
    }
...
void ftm_pwm_freq(FTMn_e ftmn, uint32 freq)             
{
    ...
    if (!(ps <= 0x07)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 491);                 
    ...
    default:
        if (!(0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 510);
        break;
    }
...
{
    if (!((ftmn == ((FTM_Type *)(0x4003A000u))))) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_ftm.c", 543);  
