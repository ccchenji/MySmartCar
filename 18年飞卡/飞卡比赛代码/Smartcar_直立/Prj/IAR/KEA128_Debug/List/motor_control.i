...
int16 LeftMotorPulseSigma = 0;          
int16 RightMotorPulseSigma = 0;         
...
void Right_Motor_Control(int32 speed)
{
	...
	if (speed >= 0)                        
	{
		...
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH3, speed);
	}
	if (speed < 0)
	{
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH2, (-speed));
...
void Left_Motor_Control(int32 speed)
{
	...
	if (speed >= 0)                        
	{
		...
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH0, speed);
	}
	if (speed < 0)
	{
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH1, (-speed));
