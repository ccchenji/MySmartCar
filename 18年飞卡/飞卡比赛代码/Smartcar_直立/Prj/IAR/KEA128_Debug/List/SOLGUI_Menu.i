...
void _UI_MENU(){{ SOLGUI_Cursor(6,0,13); SOLGUI_Widget_GotoPage(0,&UI_Debug); SOLGUI_Widget_OptionText(1, "keynum:%d" , bInCircle); SOLGUI_Widget_OptionText(2, "ADC0:%f" , Mvalue[0]); SOLGUI_Widget_OptionText(3, "ADC1:%f" , Mvalue[1]); SOLGUI_Widget_OptionText(4, "ADC2:%f" , Mvalue[2]); SOLGUI_Widget_OptionText(5, "ADC3:%f" , Mvalue[3]); SOLGUI_Widget_OptionText(6, "DirOut:%f", DirOut); SOLGUI_Widget_Spin(7, "Speed", 0x04, -100, 1000, &ExpectSpeed); SOLGUI_Widget_Spin(8, "SpeedOut", 0x04, 0, 2000, &RealSpeed); SOLGUI_Widget_OptionText(9, "Angle=%f", SystemAttitude . Pitch); SOLGUI_Widget_Spin(10, "offset", 0x04, -10000, 10000, &angle_offset); SOLGUI_Widget_Spin(11, "run", 0x02, 0, 2, &flag_run); SOLGUI_Widget_GotoPage(12, &UI_Cir); }} MENU_PAGE UI_MENU={"SmartCar",0,_UI_MENU};;


void _UI_Debug(){{ SOLGUI_Cursor(6,0,7); SOLGUI_Widget_Spin(0, "SKp", 0x04, -100, 100, &Speed_Kp); SOLGUI_Widget_Spin(1, "SKi", 0x04, -100, 100, &Speed_Ki); SOLGUI_Widget_Spin(2, "BKp", 0x04, -100, 100, &Balance_Kp); SOLGUI_Widget_Spin(3, "BKd", 0x04, -100, 100, &Balance_Kd); SOLGUI_Widget_Spin(4, "DKp", 0x04, -10000, 10000, &DirKp); SOLGUI_Widget_Spin(5, "DKd", 0x04, -10000, 10000, &DirKd); SOLGUI_Widget_OptionText(6, "DirOut:%f", DirOut); }} MENU_PAGE UI_Debug={"Debug",&UI_MENU,_UI_Debug};;

void _UI_Cir(){{ SOLGUI_Cursor(6,0,8); SOLGUI_Widget_Spin(0, "enCircle", 0x02, 0, 1, &enCircle); SOLGUI_Widget_Spin(1, "turnKp", 0x04, -100, 100, &turnKp); SOLGUI_Widget_Spin(2, "theGroung", 0x02, 0, 400, &theGroung); SOLGUI_Widget_OptionText(3, "bInCircle:%d", bInCircle); SOLGUI_Widget_Spin(4, "turnNum", 0x02, -200, 200, &turnNum); SOLGUI_Widget_Spin(5, "cirControl:", 0x02, 0,1, &cirControl); SOLGUI_Widget_Spin(6, "ToCircle", 0x02, -200, 200, &timeToCircle); SOLGUI_Widget_Spin(7, "OutCircle", 0x02, -200, 200, &timeOutCircle); }} MENU_PAGE UI_Cir={"CirNum",&UI_MENU,_UI_Cir};;
