...
{
    if (!(ms > 0)) assert_failed("F:\\\345\270\270\347\224\250\346\226\207\344\273\266\\2018_13th_NXP_Smartcar-djh_software\\Smartcar_\347\233\264\347\253\213\\Chip\\src\\KEA_wdog.c", 30);                                
...
void wdog_feed(void)
{
    ...
    unsigned long   tmp = (__iar_builtin_rsr("PRIMASK"));    
    

    
    (__iar_builtin_wsr("PRIMASK", (1)));

    
    ((((WDOG_Type *)(0x40052000u)))->CNT) = 0x02A6;
    ((((WDOG_Type *)(0x40052000u)))->CNT) = 0x80B4;

    (__iar_builtin_wsr("PRIMASK", (tmp))) ;
}
