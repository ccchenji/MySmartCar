...
{
	{(((GPIO_Type *)(0x400FF040u)))->PIDR |= (1 << 27); (((GPIO_Type *)(0x400FF040u)))->PDDR |= (1 << 27);};
	IIC_DELAY(2);
	((((GPIO_Type *)(0x400FF040u)))->PDOR |= (1 << 27));
	((((GPIO_Type *)(0x400FF040u)))->PDOR |= (1 << 28));
	IIC_DELAY(2);
	((((GPIO_Type *)(0x400FF040u)))->PDOR &= ~(1 << 27));
	IIC_DELAY(2);
	((((GPIO_Type *)(0x400FF040u)))->PDOR &= ~(1 << 28));
...
static unsigned char IIC_waitack(void)
{
	...
	((((GPIO_Type *)(0x400FF040u)))->PDOR |= (1 << 28));
	IIC_DELAY(1);
	while ((((((GPIO_Type *)(0x400FF040u)))->PDIR >> 27) & 0x01))
	{
		ErrTime++;
		if (ErrTime > 250)
		{
...
static uint8 IIC_readbyte(void)
{
	...
	while (i--)
	{
		...
		((((GPIO_Type *)(0x400FF040u)))->PDOR |= (1 << 28));
		IIC_DELAY(1);
		if ((((((GPIO_Type *)(0x400FF040u)))->PDIR >> 27) & 0x01))
		{
			ReceiveByte |= 0x01;
		}
	}
